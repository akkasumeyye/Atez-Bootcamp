...
var BaseRepository = /** @class */ (function () {
    ...
    BaseRepository.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var item;
            return __generator(this, function (_a) {
                item = __assign(__assign({}, data), { id: this.items.length + 1 });
...
// Create a new user
var newUser = { name: 'Sumeyye Akkas', email: 'sumeyyeakkas@example.com' };
userRepository.create(newUser).then(function (user) {
    console.log('Created user:', user);
});
// Update an existing user
userRepository.update(1, { name: 'Akkas Sumeyye', email: 'akkasumeyye@example.com' }).then(function (user) {
    console.log('Updated user:', user);
});
// Delete an existing user
userRepository["delete"](1).then(function () {
...
userRepository.findByEmail('sumeyyeakkas@example.com').then(function (user) {
